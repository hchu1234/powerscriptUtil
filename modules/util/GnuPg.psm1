#this file is downloaded from https://gallery.technet.microsoft.com/scriptcenter/Encrypt-and-Decrypt-Files-214db670
...
function Add-Encryption
{
	...
	(
		...
		[Parameter()]
		[ValidateNotNullOrEmpty()]
		[string]$GpgPath = 'D:\Program Files (x86)\GNU\GnuPG\gpg2.exe'
